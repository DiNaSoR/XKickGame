...
class CQuestLoadingProcess : public CBaseLoadingProcess
{
	char							m_sLoadingPath[MAX_PATH];

	int								m_nCode;
public:
	CQuestLoadingProcess(char *sText, int nCode);
	CQuestLoadingProcess();
	virtual ~CQuestLoadingProcess(void);
