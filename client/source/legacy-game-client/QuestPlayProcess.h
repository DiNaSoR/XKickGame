...
class CQuestPlayProcess : public CBasePlayProcess
{
protected:
//////////////////////////////////////////////////////////////////////////
//공통적인 튜토리얼 내용
	int								m_nQuestStep1MaxCount;//튜토리얼 완료 갯수
	...
	bool							m_bQuestStep1End;//튜토리얼 끝났나?

	bool							m_bStart;

	int								m_nQuestType;//튜토리얼 타입
...
public:
	CQuestPlayProcess();
	virtual ~CQuestPlayProcess(void);
...
public:
	...
	int								GetQuestType() { return m_nQuestType; }

	int								GetTrySuccessCount() { return m_nTrySuccessCount; } 

	void							FUNCTION_NextQuest();
};
