...
class CReplayLoadingProcess : public CBaseLoadingProcess
{
	char							m_sFileName[MAX_PATH];
public:
	CReplayLoadingProcess(const char *FileName);
	virtual ~CReplayLoadingProcess(void);
